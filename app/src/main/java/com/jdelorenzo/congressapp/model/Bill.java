...
public class Bill {
    ...
    String introducedOn;
    /** The date or time of the most recent official action. In the rare case that there are
     * no official actions, this field will be set to the value of {@link introducedOn}. */
    String lastActionAt;
    /** The date or time of the most recent vote on this bill. */
    String lastVoteAt;
    /** The date the last version of this bill was published. This will be set to the
     * {@link introducedOn} date until an official version of the bill’s text is published. */
