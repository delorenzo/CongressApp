...
import com.jdelorenzo.congressapp.DaggerAppComponent;
...
public class CongressPreferenceFragment extends android.preference.PreferenceFragment {
    ...
    private void bindPreferenceSummaryToValue(@NonNull Preference preference) {
        ...
        if (preference instanceof CheckBoxPreference) {
            preferenceChangeListener.onPreferenceChange(preference, sharedPreferences.getBoolean(preference.getKey(), false));
        } else {
            preferenceChangeListener.onPreferenceChange(preference, sharedPreferences.getString(preference.getKey(), ""));
        }
    }
